...
{	
	...
	FString SourceVersionFilePath = FPaths::Combine(CommonPaths::SourceCommonPath, TEXT("VersionInfo.json"));
	FString DestVersionFilePath = FPaths::Combine(CommonPaths::ProjectCommonPath, TEXT("VersionInfo.json"));

	bool bOverwriteCommon = PlatformFile.FileExists(*SourceVersionFilePath) && !PlatformFile.FileExists(*DestVersionFilePath);
